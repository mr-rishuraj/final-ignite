const siteContent = {
  ...
  sponsors: {
    ...
    sponsorsList: [
      { name: 'Accel', color: '#4A4A4A', initials: 'AC' },
      { name: 'WestBridge Capital', color: '#1E88E5', initials: 'WB' },
      { name: 'Microsoft', color: '#00A4EF', initials: 'MS' },
      { name: 'RBiH', color: '#003DA5', initials: 'RB' },
      { name: 'Solrazr', color: '#2563EB', initials: 'SR' },
      { name: 'HDFC Bank', color: '#C41C3B', initials: 'HB' },
      { name: 'Google', color: '#4285F4', initials: 'GG' },
      { name: 'ICICI Bank', color: '#D32F2F', initials: 'IB' },
      { name: 'HP', color: '#0096D6', initials: 'HP' },
      { name: 'Aditya Birla Ventures', color: '#E31937', initials: 'AB' },
      { name: 'Aditya Birla Group', color: '#D4AF37', initials: 'ABG' },
      { name: 'Matrix Partners', color: '#666666', initials: 'MP' },
      { name: 'Canara Bank', color: '#F39C12', initials: 'CB' },
      { name: 'IDFC First Bank', color: '#8B0000', initials: 'IF' },
      { name: 'EY', color: '#FFD700', initials: 'EY' },
      { name: 'Intel', color: '#0071C5', initials: 'IN' },
    ],
    partnersList: [
      { name: 'Oracle', color: '#FF0000', initials: 'OR' },
      { name: 'HubSpot', color: '#FF7A59', initials: 'HS' },
      { name: 'MongoDB', color: '#13AA52', initials: 'MB' },
      { name: 'Mixpanel', color: '#7B68EE', initials: 'MP' },
      { name: 'Notion', color: '#000000', initials: 'NO' },
      { name: 'Freshworks', color: '#FF6B35', initials: 'FW' },
      { name: 'Mailmodo', color: '#00B34D', initials: 'MM' },
      { name: 'DigitalOcean', color: '#0080FF', initials: 'DO' },
      { name: 'AWS', color: '#FF9900', initials: 'AWS' },
      { name: 'MathWorks', color: '#0076B6', initials: 'MW' },
      { name: 'Coinbase', color: '#1652F0', initials: 'CB' },
      { name: 'Wadhwani Foundation', color: '#FF6B35', initials: 'WF' },
      { name: 'India Accelerator', color: '#1A1A1A', initials: 'IA' },
      { name: 'Social Alpha', color: '#FF9500', initials: 'SA' },
      { name: 'The Product Folks', color: '#000000', initials: 'TPF' },
      { name: 'CIIE', color: '#000000', initials: 'CI' },
      { name: 'Builders Tribe', color: '#1A1A1A', initials: 'BT' },
      { name: 'Headstart', color: '#FF6B35', initials: 'HS' },
      { name: 'Incubate Hub', color: '#FFB81C', initials: 'IH' },
      { name: 'Entrepreneur India', color: '#1A1A1A', initials: 'EI' },
      { name: 'MoneyControl', color: '#00B34D', initials: 'MC' },
      { name: 'CNBC', color: '#E31937', initials: 'CN' },
      { name: 'Financial Express', color: '#D32F2F', initials: 'FE' },
      { name: 'YourStory', color: '#E31937', initials: 'YS' },
      { name: 'The Hindu', color: '#4A4A4A', initials: 'TH' },
      { name: 'Business Insider India', color: '#0070C9', initials: 'BI' },
      { name: 'The Indian Express', color: '#D32F2F', initials: 'IE' },
    ],
  },
  footer: {
