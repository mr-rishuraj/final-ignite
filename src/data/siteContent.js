const siteContent = {
  ...
  sponsors: {
    ...
    logos: [
      { src: 'https://framerusercontent.com/images/U3UWEJ0rFiixMujWaZhxQdeJZVY.svg', alt: 'TechVentures', name: 'TechVentures' },
      { src: 'https://framerusercontent.com/images/ze736YGI30StVzZyhVvAd6JYYAM.svg', alt: 'InnovateFund', name: 'InnovateFund' },
      { src: 'https://framerusercontent.com/images/g1JspCWG2yP8BW4YdGf0oywBhA.svg',  alt: 'GrowthLabs', name: 'GrowthLabs' },
      { src: 'https://framerusercontent.com/images/JNfwKVs04XxypCyxC4tPm2POMsY.svg', alt: 'NextGen Ventures', name: 'NextGen Ventures' },
      { src: 'https://framerusercontent.com/images/K8zbe1EcvPteDnrdhXi8Vey7X3w.svg', alt: 'DigitalEcosystem', name: 'DigitalEcosystem' },
      { src: 'https://framerusercontent.com/images/7xdhspAvQu1xiTUjQCywqlxDAVM.svg', alt: 'FutureScale', name: 'FutureScale' },
    ],
  },
  footer: {
