const siteContent = {
  ...
  sponsors: {
    ...
    row1: [
      ...
      { name: 'Microsoft', src: '', alt: 'Microsoft', color: '#00A4EF', initials: 'MS' },
      { name: 'Google', src: '', alt: 'Google', color: '#4285F4', initials: 'GG' },
      { name: 'Intel', src: '', alt: 'Intel', color: '#0071C5', initials: 'IN' },
      { name: 'HDFC Bank', src: '', alt: 'HDFC Bank', color: '#C41C3B', initials: 'HD' },
      { name: 'ICICI Bank', src: '', alt: 'ICICI Bank', color: '#D32F2F', initials: 'IC' },
      { name: 'HP', src: '', alt: 'HP', color: '#0096D6', initials: 'HP' },
      { name: 'EY', src: '', alt: 'EY', color: '#FFD700', initials: 'EY' },
      { name: 'Oracle', src: '', alt: 'Oracle', color: '#FF0000', initials: 'OR' },
      { name: 'Coinbase', src: '', alt: 'Coinbase', color: '#1652F0', initials: 'CB' },
      { name: 'MongoDB', src: '', alt: 'MongoDB', color: '#13AA52', initials: 'MB' },
      { name: 'AWS', src: '', alt: 'AWS', color: '#FF9900', initials: 'AW' },
      { name: 'Notion', src: '', alt: 'Notion', color: '#000000', initials: 'NO' },
      { name: 'HubSpot', src: '', alt: 'HubSpot', color: '#FF7A59', initials: 'HS' },
      { name: 'DigitalOcean', src: '', alt: 'DigitalOcean', color: '#0080FF', initials: 'DO' },
    ],
    row2: [
      { name: 'Freshworks', src: '', alt: 'Freshworks', color: '#FF6B35', initials: 'FW' },
      { name: 'Mailmodo', src: '', alt: 'Mailmodo', color: '#00B34D', initials: 'MM' },
      { name: 'Mixpanel', src: '', alt: 'Mixpanel', color: '#7B68EE', initials: 'MP' },
      { name: 'MathWorks', src: '', alt: 'MathWorks', color: '#0076B6', initials: 'MW' },
      ...
      { name: 'Matrix Partners', src: '', alt: 'Matrix Partners', color: '#666666', initials: 'MP' },
