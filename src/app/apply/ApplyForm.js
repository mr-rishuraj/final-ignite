      ...
      <div className={styles.successPage}>
        <div className={styles.successInner}>
          ...
          <p className={styles.successBody}>
            Thanks, <strong>{form.founderName}</strong>. We&apos;ve got your application for{' '}
            <strong>{form.startupName}</strong> and will be in touch at{' '}
    ...
    <main className={styles.page}>
      ...
      <section className={styles.right}>
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          <p className={styles.formNote}>Fields marked <span className={styles.req}>*</span> are required.</p>
          ...
          <Field label="What does your startup do?" error={errors.oneLiner} required>
            <textarea
              ...
              rows={3}
              placeholder="One sentence that captures your product and who it's for."
              value={form.oneLiner}
