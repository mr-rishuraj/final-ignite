const siteContent = {
  ...
  sponsors: {
    ...
    row1: [
      { name: 'Accel', src: 'https://logo.clearbit.com/accel.com', alt: 'Accel', color: '#4A4A4A' },
      { name: 'Microsoft', src: 'https://logo.clearbit.com/microsoft.com', alt: 'Microsoft', color: '#00A4EF' },
      { name: 'Google', src: 'https://logo.clearbit.com/google.com', alt: 'Google', color: '#4285F4' },
      { name: 'Intel', src: 'https://logo.clearbit.com/intel.com', alt: 'Intel', color: '#0071C5' },
      { name: 'HDFC Bank', src: 'https://logo.clearbit.com/hdfcbank.com', alt: 'HDFC Bank', color: '#C41C3B' },
      { name: 'ICICI Bank', src: 'https://logo.clearbit.com/icicibank.com', alt: 'ICICI Bank', color: '#D32F2F' },
      { name: 'HP', src: 'https://logo.clearbit.com/hp.com', alt: 'HP', color: '#0096D6' },
      { name: 'EY', src: 'https://logo.clearbit.com/ey.com', alt: 'EY', color: '#FFD700' },
      { name: 'Oracle', src: 'https://logo.clearbit.com/oracle.com', alt: 'Oracle', color: '#FF0000' },
      { name: 'Coinbase', src: 'https://logo.clearbit.com/coinbase.com', alt: 'Coinbase', color: '#1652F0' },
      { name: 'MongoDB', src: 'https://logo.clearbit.com/mongodb.com', alt: 'MongoDB', color: '#13AA52' },
      { name: 'AWS', src: 'https://logo.clearbit.com/amazon.com', alt: 'AWS', color: '#FF9900' },
      { name: 'Notion', src: 'https://logo.clearbit.com/notion.so', alt: 'Notion', color: '#000000' },
      { name: 'HubSpot', src: 'https://logo.clearbit.com/hubspot.com', alt: 'HubSpot', color: '#FF7A59' },
      { name: 'DigitalOcean', src: 'https://logo.clearbit.com/digitalocean.com', alt: 'DigitalOcean', color: '#0080FF' },
    ],
    row2: [
      { name: 'Freshworks', src: 'https://logo.clearbit.com/freshworks.com', alt: 'Freshworks', color: '#FF6B35' },
      { name: 'Mailmodo', src: 'https://logo.clearbit.com/mailmodo.com', alt: 'Mailmodo', color: '#00B34D' },
      { name: 'Mixpanel', src: 'https://logo.clearbit.com/mixpanel.com', alt: 'Mixpanel', color: '#7B68EE' },
      { name: 'MathWorks', src: 'https://logo.clearbit.com/mathworks.com', alt: 'MathWorks', color: '#0076B6' },
      { name: 'MoneyControl', src: 'https://logo.clearbit.com/moneycontrol.com', alt: 'MoneyControl', color: '#00B34D' },
      { name: 'CNBC', src: 'https://logo.clearbit.com/cnbctv18.com', alt: 'CNBC', color: '#E31937' },
      { name: 'Financial Express', src: 'https://logo.clearbit.com/financialexpress.com', alt: 'Financial Express', color: '#D32F2F' },
      { name: 'YourStory', src: 'https://logo.clearbit.com/yourstory.com', alt: 'YourStory', color: '#E31937' },
      { name: 'The Hindu', src: 'https://logo.clearbit.com/thehindu.com', alt: 'The Hindu', color: '#4A4A4A' },
      { name: 'Business Insider', src: 'https://logo.clearbit.com/businessinsider.com', alt: 'Business Insider', color: '#0070C9' },
      { name: 'Indian Express', src: 'https://logo.clearbit.com/indianexpress.com', alt: 'Indian Express', color: '#D32F2F' },
      { name: 'WestBridge Capital', src: 'https://logo.clearbit.com/westbridgecap.com', alt: 'WestBridge Capital', color: '#1E88E5' },
      { name: 'Matrix Partners', src: 'https://logo.clearbit.com/matrixpartners.in', alt: 'Matrix Partners', color: '#666666' },
      { name: 'India Accelerator', src: 'https://logo.clearbit.com/indiaaccelerator.co', alt: 'India Accelerator', color: '#1A1A1A' },
      { name: 'Wadhwani Foundation', src: 'https://logo.clearbit.com/wadhwani.org', alt: 'Wadhwani Foundation', color: '#FF6B35' },
    ],
  },
  footer: {
